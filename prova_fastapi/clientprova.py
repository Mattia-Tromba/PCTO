import requests
"""
r = requests.put("http://127.0.0.1:8000/db/registrazione", params={"email": "mattiatromba9@gmail.com"})
print(r.text)
...
print(r.text)
"""
#r = requests.put("http://127.0.0.1:8000/db/cambiatoken", params={"email": "<fesgrhdtg@gmail.com", "token": "dYxRgjQDK4SygRvSRbdzxOygnW"})
#print(r.text)

e = requests.post("http://127.0.0.1:8000/db/create")
a = requests.get("http://127.0.0.1:8000/db/iscrizioni/dal/2025-09-26/ad/oggi")
